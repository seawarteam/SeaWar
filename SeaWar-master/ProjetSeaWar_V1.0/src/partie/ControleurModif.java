...
public class ControleurModif {
	...
	public void demandeSauvegardeNavire(String nom, int pv, int depMax) {
		if (nom != null || nom != "" || nom != " ") {
			editeur.setNavire(nom, pv, depMax);
			editeur.sauvegarderNavire(nom);
		}
	}
	
	public void demandeSauvegardeCanon(String nom, int degat, int tpsRech) {
		if (nom != null || nom != "" || nom != " ") {
			editeur.setCanon(nom, degat, tpsRech);
